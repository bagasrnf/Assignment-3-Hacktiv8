    ...
    return (
      <section className="pt-36">
        <div className="container">
          <h1 className="mx-auto text-center font-bold  text-2xl mb-10 lg:text-3xl">
            About Me
          </h1>
          <div className="flex flex-wrap mt-4">
            ...
            <div className="w-full lg:w-1/2">
              <h4 className="font-semibold text-xl mb-3 lg:text-2xl lg:pt-10">
                About Me More!
              </h4>
              <p className="font-medium text-base text-slate-500 mb-5 lg:text-lg">
              ...
              <h4 className="font-semibold text-xl mb-4 lg:text-2xl">
                Catch Me on
                <div className="flex flex-wrap mt-4">
                  <a
