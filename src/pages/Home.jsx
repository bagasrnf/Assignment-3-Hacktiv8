        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
              ...
              <h2 className="font-medium  text-base mb-6 lg:text-xl">
                Web Development and Web Design
              </h2>

              <a
                href="#"
                className="text-base font-semibold  px-3 py-4 rounded-2xl bg-beige hover:shadow-lg hover:bg-opacity-80 transition duration-300 ease-in-out"
              >
                Say Hello 👋
              </a>
            </div>
